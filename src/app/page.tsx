  ...
  <div className={styles.card}>
    <header className={styles.header}>
      <img
        ...
        src={
          "https://cdn.snappfood.ir/350x233/uploads/images/vendors/covers/5e01b8a4bcf22.jpg"
        }
      />
      <img
        className={styles.logo}
        src={
          "https://cdn.snappfood.ir/media/cache/vendor_logo/uploads/images/vendors/logos/5e425b1b4cf0b.jpg"
        }
      />
    </header>
            ...
            >
              ...
              <defs>
                ...
                >
                  ...
                  <stop offset="1" stop-color="#00D170" stop-opacity="0"></stop>
                </linearGradient>
                <linearGradient
                  id="paint1_linear"
                  x1="7"
                ...
                >
                  ...
                  <stop offset="1" stop-color="#FF00A4" stop-opacity="0"></stop>
                </linearGradient>
              </defs>
            </svg>
          </div>
              ...
              <div>
                <div className={styles.restaurantScore}>
                  <span className="DDyzO">
                    <span className="_1Rd1d">(</span>۳۱۶۹۰
                    <span className="_1Rd1d">)</span>
                  </span>
                  <div className="mJXqQ">
                    <span className="_1wmAX">۴.۶</span>&nbsp;
                    <svg
                      width="12"
                      height="12"
                      viewBox="0 0 12 12"
      ...
      <div className="flex justify-between">
        <div className="_1Z_vY">
          <div className="_2JgbG">
            <span className="_3R-X9">پیک فروشنده </span>
            <span className="">۹,۶۰۰</span>
            <span>تومان</span>
          </div>
        </div>
        <div>تا ۲۵ دقیقه</div>
